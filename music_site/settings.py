...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-ваш-ключ-для-локальной-разработки')
...
INSTALLED_APPS = [
    ...
    'crispy_forms',
    'crispy_bootstrap5',
    'whitenoise.runserver_nostatic',  # добавлено для работы статики через WhiteNoise
    'cloudinary_storage',
    'cloudinary',
]
